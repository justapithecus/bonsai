...
Any capability that meaningfully centers these is out of scope.
...
When intent changes, it must change explicitly.
...
- opened infrequently
- updated irregularly
- consulted only a few times per year

Any capability that requires frequent attention in order to be effective violates this intent.
...
If a measurement:
- cannot be interpreted relative to declared intent
...
Any change to this file should be treated as a foundational shift and reviewed with extreme care.
